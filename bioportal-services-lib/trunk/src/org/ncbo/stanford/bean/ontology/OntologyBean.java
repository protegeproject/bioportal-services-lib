...
/**
 * Simplified version of the <code>org.ncbo.stanford.bean.concept.OntologyBean</code> class
 * used to decode the "ontologyBean" element from a successful
...
public class OntologyBean {
    ...
    private List<UserAclEntry> userAcl = new ArrayList<UserAclEntry>(0);
     ...
     * @return the userAcl
     */
    public List<UserAclEntry> getUserAcl() {
        return userAcl;
    }
     ...
     *            the userAcl to set
     */
    public void setUserAcl(List<UserAclEntry> userAcl) {
